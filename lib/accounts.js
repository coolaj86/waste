...
module.exports.createController = function (config, DB, Auth) {
  ...
  Accounts.attachLogins = function ($account, $authorizedLogins, requestedLogins) {
  ...
  Accounts.createWithLogins = function (newAccount, $authorizedLogins, requestedLogins) {
    //
...
//attachLogins
    return Accounts.create(newAccount).then(function ($account) {
      return Accounts.attachLogins($account, $authorizedLogins, requestedLogins).then(function (/*jointables*/) {
        return $account;
      });
    });
  };
...
module.exports.createRouter = function (app, config, DB, Auth) {
  ...
  Accounts.restful.create = function (req, res) {
    ...
    var promise = Accounts.createWithLogins(newAccount, authorizedLogins$, requestedLogins);
