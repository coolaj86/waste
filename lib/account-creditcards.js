        ...
        createCustomer: function (account) {
          ...
          return new Promise(function (resolve, reject) {
            ...
            , logErr('createCustomer - stripe.customers.create', reject)
              ...
              , logErr('createCustomer - save to account', reject)
            );
          });
        }
        , addCard: function (cardToken) {
          return function (customer) {
            ...
            return stripe.customers.createCard(customer.id, {
              // card.id for tokens created by stripe checkout API popup window
              // and card for custom card screens
              card: cardToken.card.id || cardToken.card
            }
      ...
      return function () {
          ...
          , logErr('makeTestTransaction - stripe.charges.capture')
            ...
            function (capture) {
              ...
              return stripe.charges.createRefund(capture.id);
            }
...
//console.log('returning promise');      
      return promise
        ...
        .then(function (cardToken) {
          ...
          return account.save().then(Promise.resolve(cardToken));
        })
      ;
    }
...
//console.log('posted to me/creditcards:' + JSON.stringify(req.body));      
    ...
    // ^ks
    rest.post('/me/creditcards/:cardId/preferred', function (req, res) {
