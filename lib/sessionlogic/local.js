...
module.exports.create = function (passport, config, loginHelpers) {
  ...
  function manualLookup(hashid, done) {
    return loginHelpers.Auth.Logins.login({ id: hashid }).then(function (login) { done(login); }, done);
  }
