...
module.exports.create = function (Db/*, config*/) {
  var Logins = require('./logins').create(Db)
    ...
    , AppLogin = Logins.Logins.create('app')
    , BearerLogin = require('./bearers').create(Logins.Logins.create('bearer'), AppLogin)
    , Auth
    ;
  ...
  function handleNewLogin(sessionObj) {
  ...
  function serialize(sessionObj, done) {
    ...
    return handleNewLogin(sessionObj).then(function (login) {
